...
class SaleOrderCustom(models.Model):
    ...
    purchase_order_list = fields.One2many('purchase.order', 'so_id', string='Purchase', compute="_compute_po_list")
    customer_number = fields.Char(related='partner_id.customer_no', string='Customer Number')
